// Generated by dojo-bindgen on Thu, 31 Oct 2024 18:13:20 +0000. Do not modify this file manually.
...
// Type definition for `jokers_of_neon::models::game_mode::beast::Beast` struct
...
// Type definition for `jokers_of_neon::models::game_mode::beast::GameModeBeast` struct
...
// Type definition for `jokers_of_neon::models::game_mode::beast::PlayerBeast` struct
...
export function defineContractComponents(world: World) {
  return {
    // Model definition for `jokers_of_neon::models::game_mode::beast::Beast` model
    Beast: (() => {
    ...
    // Model definition for `jokers_of_neon::models::game_mode::beast::GameModeBeast` model
    GameModeBeast: (() => {
      return defineComponent(
        world,
        {
    ...
    // Model definition for `jokers_of_neon::models::game_mode::beast::PlayerBeast` model
    PlayerBeast: (() => {
      return defineComponent(
        world,
        {
