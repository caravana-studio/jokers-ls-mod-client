...
export async function setupWorld(provider: DojoProvider) {
    ...
    function game_system() {
        ...
        return {
            world, name, create_game, create_level, select_deck, select_special_cards, select_modifier_cards, play, discard, end_turn, discard_effect_card, discard_special_card
        };
    }
