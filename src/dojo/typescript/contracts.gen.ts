...
export async function setupWorld(provider: DojoProvider) {
    ...
    const discard = async (props: {
      ...
      modifiers_index: number[];
        ...
        return {
            world, create_game, create_level, create_reward, select_reward, select_deck, select_special_cards, select_modifier_cards, play, discard, end_turn, discard_effect_card, discard_special_card, use_adventurer, skip_adventurer, select_aventurer_cards, name
        };
    }
    ...
    function poker_hand_system() {
        ...
        return {
            world, get_player_poker_hands, name
        };
    }
