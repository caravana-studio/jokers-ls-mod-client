...
export async function setupWorld(provider: DojoProvider) {
    ...
    const select_aventurer_cards = async (props: {
      ...
      cards_index: number[];
        ...
        return {
            name, create_game, create_level, create_reward, select_reward, select_deck, select_special_cards, select_modifier_cards, play, discard, end_turn, discard_effect_card, discard_special_card, use_adventurer, skip_adventurer, select_aventurer_cards, skip_unpassed_obstacle, world
        };
    }
    ...
    function player_system() {
        ...
        return {
            name, get_player_current_hand, get_game, world
        };
    }
    ...
    function poker_hand_system() {
        ...
        return {
            name, world, get_player_poker_hands
        };
    }
