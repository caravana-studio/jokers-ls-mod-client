...
export async function setupWorld(provider: DojoProvider) {
    ...
    const discard = async (props: {
      ...
      modifiers_index: number[];
        ...
        return {
            create_game, create_level, select_deck, select_special_cards, select_modifier_cards, play, discard, end_turn, discard_effect_card, discard_special_card, world, name
        };
    }
